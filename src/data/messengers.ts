...
export const BASIC_MESSENGERS: MessengerInfo[] = [
  ...
  },
  {
    ...
    guideSteps: [
      'Discord Developer Portal에서 New Application',
      'Bot → Add Bot → Reset Token으로 토큰 복사',
      '⚠️ MESSAGE CONTENT INTENT 활성화 필수!',
      'OAuth2 → URL Generator에서 초대 링크 생성',
      'bot + applications.commands 권한 선택',
      '서버에 봇 초대',
    ],
...
export const ADDITIONAL_MESSENGERS: MessengerInfo[] = [
  {
    ...
    guideSteps: [
      'api.slack.com/apps에서 Create New App',
