          ...
          {step === 'select' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full p-4 bg-forge-surface border border-[#2a2d3e] rounded-xl hover:border-forge-copper/50 transition-colors text-left"
              >
              ...
              <button
                ...
                className="w-full p-4 bg-forge-error/10 border border-forge-error/30 rounded-xl hover:border-forge-error/60 transition-colors text-left"
              >
                <div className="flex items-center gap-3 mb-2">
